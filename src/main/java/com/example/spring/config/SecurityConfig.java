...
import com.example.spring.auth.CustomOAuth2UserService;
...
// 1 : Spring Security 설정들을 활성화 시켜줌
// 2 : h2-console 화면을 사용하기 위해 해당 옵션들을 disable 한다.
// 3 : URL 별 권한 관리를 설정하는 옵션의 시작점, andMatchers 옵션을 사용하기 위해서 꼭 필요
/*
    4 :
...
// 5 : 설정된 값들 이외 나머지 URL 들을 나타냄, authenticated() 을 추가하여 나머지 URL 들은 모두 인증된 사용자들에게만 허용하게 한다
// 6 : 로그아웃 기능에 대한 여러 설정의 진입점, 로그아웃 성공 시 / 주소로 이동
